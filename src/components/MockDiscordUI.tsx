  ...
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        <div className="size-12 flex bg-discord-brand-color rounded-2xl items-center justify-center mb-2 hover:rounded-xl transition-all duration-200">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="my-1 space-x-px">
              {[...Array(4)].map((_, i) => (
                <div
                  className="flex items-center px-2 py-1.5 text-gray-600 cursor-not-allowed"
                  key={i}
                >
